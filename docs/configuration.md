...
A timeout that cannot provide a whole-second delivery budget reports a deduplicated configuration diagnostic and retains pending intents; use at least 2 whole seconds or zero.
