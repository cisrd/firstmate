...
| `fm-pr-lib.sh`           | Own canonical task and PR validation plus private atomic PR-poll publication, merge-notification identity, merge-queue ejection identity, automatic enqueue identity, and retirement |
