...
The same exclusivity check runs before signalling processes or removing any ship or scout worktree, not only a recognized pool slot, and on the forced-teardown descendant path as well.
