...
. "/home/awilliam/.no-mistakes/worktrees/a03e7f5d4084/01M20Y4BVJS67Y30T1QYD7T8AW/tests/wake-helpers.sh"
...
test_rewritten_status_file_does_not_reannounce_the_same_terminal_result
test_recurring_nonterminal_event_surfaces_again_at_its_new_position
find "$TMP_ROOT" -type f \( -name '*.out' -o -name .status-outcome-identity \) -print -exec cat {} \;
