...
- [docs/ntfy-notifications.md](docs/ntfy-notifications.md) - the optional outbound ntfy pager: setup, what a notification reveals, and how the channel behaves when it breaks.
